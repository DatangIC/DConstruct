...
class SingleFragmentNavigator(context: Context, manager: FragmentManager, containerId: Int) :
    ...
    private val TAG = "SingleFragmentNavigator"
    ...
    override fun navigate(
        ...
        if (mManager.isStateSaved) {
            Logger.i(TAG, "Ignoring navigate() call: FragmentManager has already" + " saved its state")
            return null
        }
